    ...
    <div className="space-y-2">
      ...
      {badge && (
        <div className="flex items-center gap-2">
          <span className={`text-[0.65625rem] px-1.5 py-0.5 rounded font-medium ${badge.active ? 'bg-[var(--success-bg)] text-[var(--success-fg)]' : 'bg-[var(--warning-bg)] text-[var(--warning-fg)]'}`}>
            {badge.label}
          </span>
          {badge.closable && (
            ...
            return (
              ...
              <li key={f.id} className="flex flex-col sm:flex-row sm:items-center gap-2 px-2.5 py-1.5 rounded-lg bg-[var(--cream)] border border-[var(--warm-border)]">
                <div className="min-w-0 flex-1 flex items-center gap-1.5 flex-wrap">
                  ...
                  <span className={`text-[0.65625rem] px-1.5 py-0.5 rounded-sm font-medium ${f.source === 'GENERATED' ? 'bg-[var(--success-bg)] text-[var(--success-fg)]' : 'bg-[var(--warning-bg)] text-[var(--warning-fg)]'}`}>
                  ...
                  {needsName && currentIds.has(f.id) && (
                    <span className="text-[0.65625rem] px-1.5 py-0.5 rounded-sm font-medium bg-[var(--success-bg)] text-[var(--success-fg)]">현재</span>
                  )}
                  ...
                  return (
                    <li key={f.id} className="flex flex-col sm:flex-row sm:items-center gap-2 px-2.5 py-1.5 rounded-lg bg-[var(--cream)] border border-[var(--warm-border)] opacity-55">
                      <div className="min-w-0 flex-1 flex items-center gap-1.5 flex-wrap">
                        ...
                        <span className="text-[0.65625rem] px-1.5 py-0.5 rounded-sm font-medium bg-[var(--danger-bg)] text-[var(--danger-fg)]">폐기됨</span>
                        <div className="flex-1 min-w-0 basis-full sm:basis-auto">
