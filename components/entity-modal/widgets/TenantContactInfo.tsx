...
export function TenantContactInfo({ contacts, email }: { contacts: Contact[]; email?: string | null }) {
  ...
  return (
    <Section title="연락처">
      ...
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <a href={phone ? `sms:${phone}` : undefined} className={`${linkCls} ${phone ? onCls : offCls}`}>문자</a>
