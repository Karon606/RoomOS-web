    ...
    <div className="space-y-1.5">
      ...
      <div className="flex gap-2">
        <select
          ...
          className="bg-[var(--canvas)] border border-[var(--warm-border)] rounded-md px-2 py-2.5 text-sm text-[var(--warm-dark)] outline-none focus:border-[var(--persimmon)] focus:shadow-[0_0_0_3px_rgba(232,74,26,0.12)] shrink-0 max-w-[44%]"
        >
          {COUNTRIES.map(c => (
        ...
        <input
          ...
          className={className ?? 'flex-1 min-w-0 bg-[var(--canvas)] border border-[var(--warm-border)] rounded-md px-3 py-2.5 text-sm text-[var(--warm-dark)] placeholder-[var(--warm-muted)] outline-none focus:border-[var(--persimmon)] focus:shadow-[0_0_0_3px_rgba(232,74,26,0.12)] transition-colors'}
        />
      </div>
      {callingCode && (
