    ...
    <div className="grid grid-cols-2 gap-3">
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full bg-[var(--canvas)] border border-[var(--warm-border)] rounded-sm px-3 py-2.5 text-sm text-[var(--warm-dark)] placeholder-[var(--warm-muted)] outline-none focus:border-[var(--persimmon)] focus:shadow-[0_0_0_3px_rgba(160,60,46,0.12)]" />
      </div>
      <div className="space-y-1.5">
