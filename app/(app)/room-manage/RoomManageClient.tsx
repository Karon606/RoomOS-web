        ...
        <div className="flex items-center gap-3 flex-wrap min-w-0">
          ...
          <ViewTabs ariaLabel="호실 관리 뷰" activeId={viewTab}
            ...
            tabs={[
              ...
              // '작업 일정'에서 '일정'으로(운영자 2026-08-29 — "퇴실예정도 있고 입실예정도 있어…
              // 이건 사실 작업이 아니잖아"). 이 트랙은 입퇴실과 작업을 함께 담으므로 둘을 다
              // 덮는 상위어가 이름이어야 한다. 앞 탭이 '작업'이라 '작업 일정'은 그 탭의 하위처럼
              // 읽히기도 했다.
              // **접미와는 여전히 어긋난다**: '일정'인데 접미는 입퇴실만 센다. 홈 타일과 앵커된
              // 값이라(착지 순간 같은 수여야 한다) 여기서 안 건드리고 운영자 판단 항목으로 남긴다.
              { id: 'moves',    label: '일정',
