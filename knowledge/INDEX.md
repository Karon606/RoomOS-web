...
- [[domain-checkout-settlement]] — 퇴실 이용료 정산 갈래 넷(위약금·면제·단기·환불 없음)·단기 기본·차액 미청구·공용 확인창·위젯 환불액 입력·퇴실 사유 승계(2026-09-02)·수납 정보 이용료 정산 카드(예상·완료·미처리, 수동 금액과 사유, 환불 record 잠금, 규칙 8)
