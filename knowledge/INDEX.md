...
- [[cash-receipt-refund]] — 현금영수증은 앱 표시일 뿐 실제 발행은 홈택스(임형진 사례)·환불 재기록의 증빙 메타 유실·**현금영수증 합계는 발행일 축, 카드는 입금일 축**(2026-08-24 정정)·미반환 보증금 수익은 정산일 축(기본 퇴실일)·기한 알림 세 자리(임박·자진발급 감경 창·요약, 조회창은 인수 컷오프)·**탭 화면 문법**(머리 합계가 제 목록을 지목·순서는 할 일 먼저 유지·`발행 내역`이지 `이력` 아님·행이 구성을 불리언으로만 말한다, 2026-09-21 신고 249f98cc)·**보증금·청소비는 받을 때 발행 대상 아님**(2026-09-21 운영자 확정 — 앱 기본값은 반대라 승인 대기)
