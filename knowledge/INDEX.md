...
- [[cash-receipt-refund]] — 현금영수증은 앱 표시일 뿐 실제 발행은 홈택스(임형진 사례)·환불 재기록의 증빙 메타 유실·**현금영수증 합계는 발행일 축, 카드는 입금일 축**(2026-08-24 정정)·미반환 보증금 수익은 정산일 축(기본 퇴실일)·기한 알림 세 자리(임박·자진발급 감경 창·요약, 조회창은 인수 컷오프)
