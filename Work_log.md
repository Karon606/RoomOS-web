...
### 과거월 배너 컴팩트화 (PastMonthBanner) [표시 전용]
운영자 피드백: 홈 과거월 배너 문구가 너무 큼("· 지난달 보는 중 — 현재 월 아님"·오글거림). → 슬림 바 "2026년 6월 (지난달) [오늘]"로 축소(px-3 py-1.5, text-xs, 좌측 5px 강조선 제거). amber 유지로 여전히 눈엔 띔. 페이지 범위(MONTH_PAGES) 재조정은 후속 확인(카드정산·요청은 현재 월 단위 아님).
