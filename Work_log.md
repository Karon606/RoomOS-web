...
**1번 = 산식 정상, 표시 문제.** `computeInventoryOverview`를 직접 호출해 실측. 일당 환산 시 쌀 2.5/3.6/2.8, 라면 3.8/6.5/4.4로 안정적. 편차가 커 보인 원인은 (a) 추적 시작 전 달이 0 막대, (b) 진행 중인 달(7월=17일치)을 만월과 나란히 표시. 미개선(별건, knowledge 기록).
