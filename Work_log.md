...
- 411호 현금 추천(891269cb): 로직 정상(고객별 직전 결제수단 프리필). 2026-06월 수납 기록에 payMethod '현금'이 저장돼 있음 — 데이터 정정은 §4라 운영자 확인 대기.
- 신고 done: ae22675d(문구 일반화), 5ce9d3f8(직업 해제), ab8670c2(쌀). 남은 open: 891269cb(운영자 답변 대기), 4fad73fa(단체 공지, R4).
