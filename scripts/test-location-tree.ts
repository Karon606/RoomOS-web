...
// 접두가 **단어 일부**여도 접두가 아니다 — 경계가 공백이어야 한다(`4층 주` 는 `4층 주방` 의 앞토막).
eq('보존: 접두가 단어 일부면 제안 없음', preserveName('4층 주방 김치냉장고', '4층 주'), null)
// 부모 경로에 공백이 들어도 규칙은 같다 — 떼고 남은 **나머지 전체**가 한 칸의 이름이 된다.
eq('보존: 공백 든 부모 경로도 나머지 전체가 이름', preserveName('4층 공용 화장실 선반', '4층 공용'), '화장실 선반')
