...
function fileNameTests() {
  ...
  eq('항목별 확장자 · 섞인 형식', shareFileNames([김, 박], [1, 1], ['jpg', 'pdf']),
    ['김상혁_실거주확인서.jpg', '박서준_입실료납부확인서.pdf'])
  eq('항목별 확장자 · 배열이 짧으면 첫 값으로', shareFileNames([김, 박], [1, 1], ['pdf']),
    ['김상혁_실거주확인서.pdf', '박서준_입실료납부확인서.pdf'])
  eq('항목별 확장자 · 다페이지에도 항목 확장자', shareFileNames([김, 박], [2, 1], ['png', 'pdf']),
    ['김상혁_실거주확인서_1.png', '김상혁_실거주확인서_2.png', '박서준_입실료납부확인서.pdf'])
