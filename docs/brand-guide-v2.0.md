...
- 상태 다크: PAID #A3BF7B/rgba(163,191,123,.14) · AWAIT #93A9D1/.14 · UNPAID #D9A648/.14 · OVERDUE #E08A75 텍스트, solid 배지 --tc 유지 (틴트 배경은 --overdue-bg 폐지 후 --band-overdue-bg 로, §03) · VACANT --d-ink-m / rgba(242,232,220,.06). 밴드 표면 5종 다크값도 §03 표에 있다.
...
- 시각 지문 점검(2026-08-25 정비): 글자를 담는 rounded-full 0(감지망 check-pill-text) · 정상 상태 카드 립 0(예외는 §18 — 수납 관리만 전면) · 코랄 채움 모조 필터·선택 칩 0(§03·§23).
