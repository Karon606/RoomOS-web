...
export const RECOMMENDED_CLEANING_TRANSLATION: Record<'clause' | 'none' | 'deduct', Record<TranslationLang, string>> = {
  clause: { en: '[Cleaning Fee] The cleaning fee of {{청소비}} is payment for the indoor cleaning service performed after move-out. If there is a deposit, it is deducted from the deposit at the move-out settlement; if there is no deposit, it is collected at move-in together with the room fee.', vi: '[Phí vệ sinh] Phí vệ sinh {{청소비}} là khoản đối giá cho dịch vụ vệ sinh bên trong phòng sau khi trả phòng. Trường hợp có tiền đặt cọc, khoản này được khấu trừ từ tiền đặt cọc khi quyết toán trả phòng; trường hợp không có tiền đặt cọc, khoản này được thu cùng với tiền phòng khi vào ở.', bn: '[পরিষ্কার ফি] পরিষ্কার ফি {{청소비}} হলো কক্ষ ত্যাগের পর কক্ষের ভেতরে পরিষ্কারের সেবার বিনিময় মূল্য। জামানত থাকলে কক্ষ ত্যাগের হিসাব নিষ্পত্তির সময় জামানত থেকে কেটে নেওয়া হয়, আর জামানত না থাকলে বসবাস শুরুর সময় বসবাস ফি-এর সঙ্গে নেওয়া হয়।', ru: '[Плата за уборку] Плата за уборку в размере {{청소비}} является вознаграждением за услуги по уборке помещения после выезда. При наличии залога она удерживается из залога при расчёте на момент выезда, при отсутствии залога она взимается при заселении вместе с платой за проживание.', ja: '[清掃費] 清掃費 {{청소비}} は、退去後の室内清掃役務の対価です。保証金がある場合は退去精算時に保証金から控除し、保証金がない場合は入居時に利用料と併せて受領します。', zh: '【清洁费】清洁费 {{청소비}} 为搬离后室内清洁服务的对价。有押金的，于搬离结算时从押金中扣除；无押金的，于入住时与使用费一并收取。', zht: '【清潔費】清潔費 {{청소비}} 為遷出後室內清潔服務之對價。有押金者，於遷出結算時自押金中扣除；無押金者，於入住時與使用費一併收取。' },
  none: { en: '[Cleaning Fee] This Agreement has no cleaning fee. No amount is deducted as a cleaning fee at move-out.', vi: '[Phí vệ sinh] Hợp đồng này không có phí vệ sinh. Khi trả phòng không khấu trừ bất kỳ khoản nào với danh nghĩa phí vệ sinh.', bn: '[পরিষ্কার ফি] এই চুক্তিতে কোনো পরিষ্কার ফি নেই। কক্ষ ত্যাগের সময় পরিষ্কার ফি বাবদ কোনো কর্তন করা হয় না।', ru: '[Плата за уборку] Настоящий договор не предусматривает платы за уборку. При выселении удержание в счёт платы за уборку не производится.', ja: '[清掃費] 本契約に清掃費はありません。退去時に清掃費名目での控除は行いません。', zh: '【清洁费】本合同无清洁费。搬离时不以清洁费名义扣除。', zht: '【清潔費】本契約無清潔費。遷出時不以清潔費名義扣除。' },
