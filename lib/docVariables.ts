...
export const DOC_VARIABLES: readonly DocVariableEntry[] = [
  ...
  { key: '단기요금표', shown: '{{단기요금표}}', grammar: 'doc', kind: 'derived', label: '단기 입실 요금표', source: '단기 입실 정책(영업장) x 그 방 월세로 계산', editTab: 'pricing', editAnchor: 'dv-short-stay', editLabel: '요금·정책 탭 · 단기 입실 정책' },
  ...
  { key: '영업장명', shown: '{{영업장명}}', grammar: 'consent', kind: 'property', label: '상호(등기)', source: '사업자 정보의 상호', editTab: 'contract', editAnchor: 'dv-biz-info', editLabel: '계약서·서류 탭 · 사업자 정보', note: '문자·메일의 {영업장명}과 다른 값이다 — 그쪽은 영업장 이름(간판)' },
  ...
  { key: '영업장명', shown: '{영업장명}', grammar: 'msg', kind: 'property', label: '영업장 이름(간판)', source: '기본정보의 영업장명', editTab: 'basic', editAnchor: 'dv-basic-property', editLabel: '기본정보 탭 · 영업장명', note: '동의서의 {{영업장명}}(상호)과 다른 값이다' },
  ...
  { key: '영업장주소', shown: '(직접 인쇄)', grammar: 'direct', kind: 'property', label: '영업장 주소(건물 소재지)', source: '실거주 확인서 소재지·입주자 주소', editTab: 'basic', editAnchor: 'dv-basic-property', editLabel: '기본정보 탭 · 주소', note: '사업장 주소(등록증 표기)와 다른 사실이다 — 합치지 않는다' },
