...
// 넷째 불변식(영업장 안 전체 이름 유일)은 표기 경로를 만들어야 판정되므로 lib/locationPaths 의
// conflictingPathName 이 맡는다 — 형제 유일만으로는 루트 `4층 김치냉장고 상단` 과 트리
// `4층 김치냉장고` 아래 `상단` 이 둘 다 통과해 전체 이름이 글자까지 같아진다.
//
